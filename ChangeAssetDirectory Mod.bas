...
Public Function ChangeAssetDirectoryCreate(frm As Form, FormTypeID)
...
Public Function UpdateApplicationSetting(frm As Form, ApplicationSettingName, vApplicationSettingValue)
