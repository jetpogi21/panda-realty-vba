...
Public Function BrowserDataSourceDatabaseFile(frm As Form)
...
Private Function GenerateImportDataFields(ImportDataID, sourceTableName, sourceFields, destinationFields, joinObjs As Collection) As Boolean
    ...
    If DestinationConnector = "RecordImportID" Then
        sourceFieldArr.Add "[" & sourceTableName & "]." & SourceConnector & " AS RecordImportID"
...
Public Function ImportDataClick(frm As Form, Optional Notify As Boolean = True)
    ...
    Dim sourceFields, destinationFields, joinObjs As New Collection, joinObj
    If ExitIfTrue(Not GenerateImportDataFields(ImportDataID, sourceTableName, sourceFields, destinationFields, joinObjs), _
    ...
    If sourceTableName = "Sales-Junction" Then
        Debug.Print ""
    End If
