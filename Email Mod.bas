...
Public Function SendFileToEmail(frm As Form, Subject, filePath, recipientEmail, HTMLBody)
...
Public Function ComposeMail(frm As Form, Optional TextBoxName = "EmailAddress")
